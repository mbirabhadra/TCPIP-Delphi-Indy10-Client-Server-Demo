...
{ ******************************************************************************
      ...
      minor bug :  "Cannot get file from client, Unknown error occured "
                    ignore this bug, just wrong info in memo :-)
...
procedure TFileExchangeServerForm.btn_LoadFileClick(Sender: TObject);
begin
