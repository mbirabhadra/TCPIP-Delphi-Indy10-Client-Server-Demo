...
uses
  ...
  IdTCPServer, IdSync, Unit_Indy_Classes, Unit_Indy_Functions, Vcl.ExtCtrls, IdGlobal;
...
var
  Form1: TForm1;
  MyRecord: TMyRECORDThreadSafeRecord;
...
begin
  ...
  MyRecord := TMyRECORDThreadSafeRecord.Create;
end;
