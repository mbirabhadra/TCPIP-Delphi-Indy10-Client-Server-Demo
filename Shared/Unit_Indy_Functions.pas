...
uses IdBaseComponent, IdContext, IdComponent, IdTCPConnection, IdTCPClient,
  StdCtrls,
  SysUtils, Variants, Classes, Graphics, Controls, Forms, Unit_Indy_Classes, IdGlobal;
...
type
  ...
  public
    ...
    /// Byte Array
    /// </param>
    function ByteArrayToMyRecord(ABuffer: IdGlobal.TIdBytes): TRecordType;
    ...
    /// </param>
    function MyRecordToByteArray(aRecord: TRecordType): IdGlobal.TIdBytes;
  ...
  /// </summary>
function ReceiveBuffer(AClient: TIdTCPClient; var ABuffer: IdGlobal.TIdBytes)  : Boolean; overload;

/// <summary>
/// Function for transfer of Bytes Arrays via INDY 10 TCP IP Servers
/// </summary>
function SendBuffer(AClient: TIdTCPClient; ABuffer: IdGlobal.TIdBytes): Boolean; overload;

/// <summary>
/// Function for transfer of Bytes Arrays via INDY 10 TCP IP Servers
/// </summary>
function ReceiveBuffer(AContext: TIdContext; var ABuffer: IdGlobal.TIdBytes)  : Boolean; overload;

/// <summary>
/// Function for transfer of Bytes Arrays via INDY 10 TCP IP Servers
/// </summary>
function SendBuffer(AContext: TIdContext; ABuffer: IdGlobal.TIdBytes): Boolean; overload;
...
/// Byte Array
/// </param>
function ByteArrayToMyRecord(ABuffer: IdGlobal.TIdBytes): TMyRecord;
...
/// adjust this record definition to your needs
/// </param>
function MyRecordToByteArray(aRecord: TMyRecord): IdGlobal.TIdBytes;
...
function ReceiveBuffer(AContext: TIdContext; var ABuffer: IdGlobal.TIdBytes)
  : Boolean; overload;
var
  LSize: LongInt;
begin
...
function TGenericRecord<TRecordType>.MyRecordToByteArray
  (aRecord: TRecordType): IdGlobal.TIdBytes;
var
  LSource: PAnsiChar;
begin
  LSource := PAnsiChar(@aRecord);
...
function TGenericRecord<TRecordType>.ByteArrayToMyRecord(ABuffer: IdGlobal.TIdBytes)
  : TRecordType;
var
  LDest: PAnsiChar;
begin
